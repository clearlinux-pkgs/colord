...
Source0  : https://www.freedesktop.org/software/colord/releases/colord-1.4.7.tar.xz
Source1  : https://www.freedesktop.org/software/colord/releases/colord-1.4.7.tar.xz.asc
...
%prep
%setup -q -n colord-1.4.7
cd %{_builddir}/colord-1.4.7
pushd ..
cp -a colord-1.4.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705940820
...
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dlocalstatedir=/var \
...
ninja -v -C builddir
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dlocalstatedir=/var \
-Dargyllcms_sensor=false \
-Ddaemon_user=colord \
-Ddocs=false \
-Dman=false \
...
cp %{_builddir}/colord-%{version}/COPYING %{buildroot}/usr/share/package-licenses/colord/4cc77b90af91e615a64ae04893fdffa7939db84c || :
...
%files bin
%defattr(-,root,root,-)
/V3/usr/bin/cd-create-profile
/V3/usr/bin/cd-fix-profile
/V3/usr/bin/cd-iccdump
/V3/usr/bin/cd-it8
/V3/usr/bin/colormgr
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/colord-plugins/libcolord_sensor_camera.so
/V3/usr/lib64/colord-plugins/libcolord_sensor_scanner.so
/V3/usr/lib64/colord-sensors/libcolord_sensor_argyll.so
/V3/usr/lib64/colord-sensors/libcolord_sensor_colorhug.so
...
%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/colord
/V3/usr/libexec/colord-session
/usr/libexec/colord
...
%files tests
%defattr(-,root,root,-)
/V3/usr/libexec/installed-tests/colord/colord-test-daemon
/V3/usr/libexec/installed-tests/colord/colord-test-private
